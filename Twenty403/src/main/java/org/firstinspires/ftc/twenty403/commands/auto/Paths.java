...
public class Paths {
    ...
    public static Command FirstObsPath(Robot r) {
        return new SequentialCommandGroup(
                new TrajectorySequenceCommand(
                        r.drivebaseSubsystem,
                        AutoConstants.FIRST_TO_SECOND),
                new TrajectorySequenceCommand(
                        r.drivebaseSubsystem,
                        AutoConstants.SECOND_TO_THIRD
                ),
                new TrajectorySequenceCommand(
                        r.drivebaseSubsystem,
                        AutoConstants.THIRD_TO_FOURTH
                ),
                new TrajectorySequenceCommand(
                        r.drivebaseSubsystem,
                        AutoConstants.FOURTH_TO_FIFTH
                ),
                new TrajectorySequenceCommand(
                        r.drivebaseSubsystem,
                        AutoConstants.FIFTH_TO_SIXTH
                ),
                new TrajectorySequenceCommand(
                        r.drivebaseSubsystem,
                        AutoConstants.SIXTH_TO_SEVENTH
                ),
                new TrajectorySequenceCommand(
                        r.drivebaseSubsystem,
                        AutoConstants.SEVENTH1_TO_SEVENTH2
                ),
                new TrajectorySequenceCommand(
                        r.drivebaseSubsystem,
                        AutoConstants.SEVENTH2_TO_SEVENTH3
                ),
                new TrajectorySequenceCommand(
                        r.drivebaseSubsystem,
                        AutoConstants.SEVENTH3_TO_SEVENTH4
                ),
                new TrajectorySequenceCommand(
                        r.drivebaseSubsystem,
                        AutoConstants.SEVENTH4_TO_EIGHTH
                ),
                new TrajectorySequenceCommand(
                        r.drivebaseSubsystem,
                        AutoConstants.EIGHTH_TO_EIGHTH1
                ),
                new TrajectorySequenceCommand(
                        r.drivebaseSubsystem,
                        AutoConstants.EIGHTH1_TO_EIGHTH2
                ),
                new TrajectorySequenceCommand(
                        r.drivebaseSubsystem,
                        AutoConstants.EIGHTH2_TO_EIGHTH3
                ),
                new TrajectorySequenceCommand(
                        r.drivebaseSubsystem,
                        AutoConstants.EIGHTH3_TO_EIGHTH4
                ),
                new TrajectorySequenceCommand(
                        r.drivebaseSubsystem,
                        AutoConstants.EIGHTH4_TO_NINTH
                ),
                new TrajectorySequenceCommand(
                        r.drivebaseSubsystem,
                        AutoConstants.NINTH_TO_TENTH
                ),
                new TrajectorySequenceCommand(
                        r.drivebaseSubsystem,
                        AutoConstants.TENTH_TO_ELEVENTH
                ),
                new TrajectorySequenceCommand(
                        r.drivebaseSubsystem,
                        AutoConstants.ELEVENTH_TO_TWELFTH
                ),
                new TrajectorySequenceCommand(
                        r.drivebaseSubsystem,
                        AutoConstants.ELEVENTH_TO_TWELFTH
                ...
                new TrajectorySequenceCommand(
                        r.drivebaseSubsystem,
                        AutoConstants.TWELFTH_TO_THIRTEENTH
                )

...
@Autonomous(name = "ObsParking")
@SuppressWarnings("unused")
public class ObsPark extends CommandOpMode {
    ...
    public void uponInit() {
        ...
        robot.drivebaseSubsystem.setPoseEstimate(AutoConstants.OBS_STARTY.toPose());
        //CommandScheduler.register(robot.verticalSlidesSubsystem);
        CommandScheduler.scheduleForState(
            new SequentialCommandGroup(
                Paths.Obs_Parking(robot),

...
public class AutoConstants {
        public static ConfigurablePoseD TEST1 = new ConfigurablePoseD(20, 56, 0);
        public static ConfigurablePoseD TEST2 = new ConfigurablePoseD(56, 50, 45);
        public static ConfigurablePoseD TEST3 = new ConfigurablePoseD(56, 37, 90);
        public static ConfigurablePoseD TEST4 = new ConfigurablePoseD(56, 50, 45);
        public static ConfigurablePoseD TEST5 = new ConfigurablePoseD(62, 25, -180);
        public static ConfigurablePoseD TEST6 = new ConfigurablePoseD(56, 50, 45);
        public static ConfigurablePoseD TEST7 = new ConfigurablePoseD(47, 25, 90);
       // public static ConfigurablePoseD TEST9= new ConfigurablePoseD(56, 50, 45);
       // public static ConfigurablePoseD TEST10 = new ConfigurablePoseD(38, 38, -90);

        public static ConfigurablePoseD TEST8 = new ConfigurablePoseD(23, 9, -180);
        // BEYBLADE BEYBLADE BEYBLADE
/*
        public static ConfigurablePoseD TEST1 = new ConfigurablePoseD(17, 56, 180);
        public static ConfigurablePoseD TEST2 = new ConfigurablePoseD(37, 35, 350);
...
*/
        ...
        public static final Function<Function<Pose2d, TrajectorySequenceBuilder>, TrajectorySequence>
                TEST1_TO_TEST2 = b ->
                b.apply(TEST1.toPose())
                        .splineToSplineHeading(TEST2.toPose(),Math.PI - TEST2.getHeading())
                        .splineToSplineHeading(TEST3.toPose(),Math.PI - TEST3.getHeading())
                        .splineToSplineHeading(TEST4.toPose(),Math.PI - TEST4.getHeading())
                        .splineToSplineHeading(TEST5.toPose(),Math.PI - TEST5.getHeading())
                        .splineToSplineHeading(TEST6.toPose(),Math.PI - TEST6.getHeading())
                        .splineToSplineHeading(TEST7.toPose(),Math.PI - TEST7.getHeading())
                        .build();
        public static final Function<Function<Pose2d, TrajectorySequenceBuilder>, TrajectorySequence>
                TEST2_TO_TEST3 = b ->
                b.apply(TEST7.toPose()).lineToLinearHeading(TEST8.toPose()).build();
